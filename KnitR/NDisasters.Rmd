...
###Data Miner
These visuals were inspired by the cluster analysis done in Oracle Data Miner. We ran various attributes that we thought might be interesting to cluster and the ones that seemed most interesting were our two measures with income group. We further
