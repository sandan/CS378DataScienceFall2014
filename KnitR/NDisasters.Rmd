...
![per Capita SQL Query](Images/Per Capita Analysis/perCapitaQuery.png)
...
![per Capita Sample Workflow](Images/Per Capita Analysis/perCapitaWorkflow.png)
...
![OECD Map](Images/Per Capita Analysis/OECDmap.jpg)
